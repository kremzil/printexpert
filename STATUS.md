...
- Матрицы цен из WP-таблиц:
  ...
  - Добавление новых матриц через Dialog с выбором свойства (выпадашка), значений, типа и breakpoints.
  - Названия новых матриц формируются как `название продукта – название свойства`.
