  ...
  return (
    <ComboboxPrimitive.List
      ...
      className={cn(
        ...
        showScrollbar
          ? "[scrollbar-width:thin] [scrollbar-color:var(--color-foreground)_var(--color-muted)] [&::-webkit-scrollbar]:block [&::-webkit-scrollbar]:w-2.5 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-muted/70 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-foreground/65 [&::-webkit-scrollbar-thumb:hover]:bg-foreground/85"
          : "no-scrollbar",
        className
      )}
      {...props}
